...
class MainWindow:
    def __init__(self):
        ...
        try:
            ...
            log_error("Помилка ініціалізації WebDriver", e)
    ...
    def on_closing(self):
        ...
        if self.driver:
            try:
                ...
                log_error("Помилка закриття WebDriver", e)
        self.root.destroy()
    ...
    def fix_action(self):
        ...
        if action_type in ["введення_тексту", "натискання_клавіші", "пошук_за_xpath", "пошук_за_css"]:
            ...
            if action_type == "введення_тексту":
                ...
                action["selector"] = extra_value  # Селектор може бути порожнім
    ...
    def edit_action_in_window(self):
        ...
        def save_edit():
            ...
            if new_action_type == "введення_тексту":
                ...
                new_action["selector"] = extra_entry.get()  # Селектор може бути порожнім
            if delay_value:
    ...
    def update_templates_list(self):
        ...
        for template in templates:
            ...
            checkbutton = tk.Checkbutton(self.run_templates_scrollable_frame, text=template, variable=var,
                                         font=DEFAULT_CONFIG["default_font"],
                                         command=self.update_profiles_list)  # Виправлено помилку
            checkbutton.pack(anchor=tk.W, padx=1)
            ...
            def execute_action(action, action_callback, retries=2, index=0):
                ...
                try:
                    ...
                    if action['type'] == "подвійний_клік":
                        ...
                        if not self.driver:
                            raise ValueError("WebDriver не ініціалізований")
